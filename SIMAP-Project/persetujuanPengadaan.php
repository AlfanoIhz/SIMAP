...
<body>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (empty($data['status'])) { ?>
                                    <button class="approve" data-id="<?php echo $data['idPengajuanPengadaan']; ?>">Approve</button>
                                    <button class="reject" data-id="<?php echo $data['idPengajuanPengadaan']; ?>">Reject</button>
                                <?php } ?>
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <script>
        ...
        function updateStatus(button, status) {
            ...
            xhr.open('POST', 'php/statusPengadaan.php', true);
