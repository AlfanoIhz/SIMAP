...
<head>
    ...
    <link rel="stylesheet" href="style/style-persetujuanAlokasi.css">
...
<body>
    <div id="daftarPengajuan">
        <div class="container"> 
            ...
            <div class="box">
                <h2>Persetujuan Alokasi Aset</h2>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (empty($data['status'])) { ?>
                                    <button class="approve" data-id="<?php echo $data['idPengajuanAlokasi']; ?>">Approve</button>
                                    <button class="reject" data-id="<?php echo $data['idPengajuanAlokasi']; ?>">Reject</button>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php } ?>
    ...
    <script>
        ...
        function updateStatus(button, status) {
            ...
            xhr.open('POST', 'php/statusAlokasi.php', true);
