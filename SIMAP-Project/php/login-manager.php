...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_user = mysqli_query($mysqli, "SELECT * FROM manager WHERE username='$username' AND password='$password'");
    ...
    if ($cek_user > 0) {
        ...
        header('Location: ../manager-page/page-beranda.php');
        exit();
    } else {
        ...
        header('Location: ../manager-page/login-manager.php');
        exit();
    }
} else {
