...
<head>
    ...
    <title>Form Tambah Pengajuan Pembuangan</title>
...
<body>
    <div id="daftarAset">
        <div class="container"> 
            ...
            <div class="box">
            <h1>Ajukan Pembuangan Aset</h1>
                <form action="../php/ajukanPembuangan.php" method="POST">
                    ...
                    <label for="tanggalPembuangan">Tanggal Pembuangan</label>
                    <input type="date" id="tanggalPembuangan" name="tanggalPembuangan" required>

                    <label for="alasanPembuangan">Alasan Pembuangan</label>
                    <textarea type="text" rows="10" cols="30" id="alasanPembuangan" name="alasanPembuangan" required></textarea>

                    <div class="action-btn">
                        <a href="page-pembuanganDepartemen.php"><button type="button" class="btn-kembali">Kembali</button></a>
