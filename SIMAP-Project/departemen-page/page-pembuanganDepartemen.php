...
<body>
    <div id="daftarAset">
        <div class="container"> 
            ...
            <div class="box">
                <h2>Pengajuan Pembuangan Aset</h2>
                <!-- Tambah Pengajuan -->
                <a href="form-tambahPembuangan.php"><button class="btn-tambah-pem"><i class="fa-solid fa-plus" style="color: #ffff; font-size: 20px;"></i>
                Ajukan Pembuangan Aset</button></a>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
