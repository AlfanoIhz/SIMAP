...
<head>
    ...
    <title>Form Tambah Pengajuan Pemeliharaan</title>
...
<body>
    <div id="daftarAset">
        <div class="container"> 
            ...
            <div class="box">
            <h1>Ajukan Pemeliharaan Aset</h1>
                <form action="../php/ajukanPemeliharaan.php" method="POST">
                    ...
                    <label for="tanggalPemeliharaan">Tanggal Pemeliharaan</label>
                    <input type="date" id="tanggalPemeliharaan" name="tanggalPemeliharaan" required>

                    <label for="alasanPemeliharaan">Alasan Pemeliharaan</label>
                    <textarea type="text" rows="10" cols="30" id="alasanPemeliharaan" name="alasanPemeliharaan" required></textarea>

                    <div class="action-btn">
                        <a href="page-pemeliharaanDepartemen.php"><button type="button" class="btn-kembali">Kembali</button></a>
